...
class Initializer {
	...
	public function initialize_panels() {
		...
		add_action( 'admin_enqueue_scripts', [ $this, 'admin_css' ], 10 );

		$this->register_panels( \ModularContent\Plugin::instance()->registry() );
	}

	public function admin_css(){
		/** @var Asset_Loader $assets */
		$assets = tribe_project()->container()[ 'assets' ];

		$assets->register_and_enqueue_stylesheet( 'core-admin-panels', 'admin/panels/panels.css' );
	}
